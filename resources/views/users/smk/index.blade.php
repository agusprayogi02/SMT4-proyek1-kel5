                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                <a class="btn btn-icon icon-left btn-primary" {{-- href="{{ route('users.smk.create') }}">Create New SMK</a> --}} <a
                            ...
                            <div class="show-search mb-3" style="display: none">
                                <form id="search" method="GET" action="{{ route('menu-group.index') }}">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <a class="btn btn-secondary" href="{{ route('users.smk.index') }}">Reset</a>
                                    </div>
                                </form>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <div class="d-flex justify-content-end">
                                                        <a href="{{ route('users.smk.edit', $item->id) }}"
                                                            class="btn btn-sm btn-info btn-icon "><i
                                                                class="fas fa-edit"></i>
                                                            Edit</a>
                                                        <form action="{{ route('users.smk.destroy', $item->id) }}"
