...
<section class="section">
  <div class="section-header">
    <h1>{{ isset($keahlian) ? 'Edit' : 'Buat' }} Keahlian</h1>
    <div class="section-header-breadcrumb">
      <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
      <div class="breadcrumb-item"><a href="#">Components</a></div>
      <div class="breadcrumb-item">{{ isset($keahlian) ? 'Edit' : 'Buat' }} Keahlian</div>
    </div>
  </div>
  <div class="section-body">
    <h2 class="section-title">{{ isset($keahlian) ? 'Edit' : 'Buat' }} Keahlian</h2>
    <div class="card">
      <form action="{{ isset($keahlian) ? route('keahlian.update', $keahlian) : route('keahlian.store') }}"
        method="POST">
        <div class="card-header">
          <h4>Validasi {{ isset($keahlian) ? 'Edit' : 'Buat' }} Keahlian</h4>
        </div>
        <div class="card-body">
          @csrf
