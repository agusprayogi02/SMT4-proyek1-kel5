        ...
        <div class="card card-primary">
          <div class="card-header">
            ...
            <div class="card-header-action">
              <a class="btn btn-icon icon-left btn-primary" href="{{ route('laporan.harian.create') }}">Create New
                Laporan
                Harian</a>
              ...
              {{-- <a class="btn btn-info btn-primary active" href="{{ route('menu-group.export') }}">
                ...
                Export dataName</a> --}}
              <a class="btn btn-info btn-primary active search"> <i class="fa fa-search" aria-hidden="true"></i> Search
                Laporan Harian</a>
            </div>
          </div>
          <div class="card-body">
              ...
              <table class="table table-bordered table-md">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $item->tanggal }}</td>
                    <td><img src="{{ $item->image }}" alt="{{ $item->image }}" class="img-thumbnail rounded"></td>
                    <td>{{ $item->keterangan }}</td>
                    <td class="text-right">
                      <div class="d-flex justify-content-end">
                        <a href="{{ route('laporan.harian.edit', $item->id) }}" class="btn btn-sm btn-info btn-icon "><i
                            class="fas fa-edit"></i>
                          Edit</a>
                        <form action="{{ route('laporan.harian.destroy', $item->id) }}" method="POST" class="ml-2">
